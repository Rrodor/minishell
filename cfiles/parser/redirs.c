...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/26 01:14:38 by rrodor            #+#    #+#             */
/*   Updated: 2023/07/26 01:14:39 by rrodor           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	add_new_redirection(t_lexer *tmp, t_parser *parser_tools)
{
	...
	lexer_add_back(&parser_tools->redirections, node);
	index_1 = tmp->i;
	index_2 = tmp->next->i;
	lexer_del_one(&parser_tools->lexer_list, index_1);
	lexer_del_one(&parser_tools->lexer_list, index_2);
